...
def filter_MACSiq(work_dir, preprocessed_dir):
    output_dir = Path(preprocessed_dir/work_dir.name)
...
def fix_antibody(panel, metadata_dir):
...
#Extract expression data function
def exp_MACSiq(work_dir, preprocessed_dir, metadata_dir):
    output_dir = Path(preprocessed_dir/work_dir.name)
